...
class Ui_ProfessionPage(object):
    def setupUi(self, ProfessionPage):
        ...
        ProfessionPage.resize(1920, 1118)
...
"font-family: Roboto;")
        ...
        self.verticalLayout_5 = QVBoxLayout(self.professionPage)
...
"}")
        ...
        self.findInput.setPalette(palette4)
        font3 = QFont()
...
"}")
        ...
        self.profession = QFrame(self.professionPage)
        self.profession.setObjectName(u"profession")
        self.profession.setMaximumSize(QSize(346, 16777215))
        self.profession.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_2 = QVBoxLayout(self.profession)
        ...
        self.professionName.setPalette(palette5)
        font4 = QFont()
...
"}")
        ...
        self.verticalLayout_2.addLayout(self.professionButtons)

        self.verticalLayout = QVBoxLayout()
        self.verticalLayout.setSpacing(10)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.vacancy = QLabel(self.profession)
        ...
        self.prof_1 = QLabel(self.profession)
        ...
        self.prof_1.setPalette(palette7)
        self.prof_1.setFont(font5)
        self.prof_1.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_1)

        self.prof_2 = QLabel(self.profession)
        ...
        self.prof_2.setPalette(palette8)
        self.prof_2.setFont(font5)
        self.prof_2.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_2)

        self.prof_3 = QLabel(self.profession)
        ...
        self.prof_3.setPalette(palette9)
        self.prof_3.setFont(font5)
        self.prof_3.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_3)

        self.prof_4 = QLabel(self.profession)
        ...
        self.prof_4.setPalette(palette10)
        self.prof_4.setFont(font5)
        self.prof_4.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_4)

        self.prof_5 = QLabel(self.profession)
        ...
        self.prof_5.setPalette(palette11)
        self.prof_5.setFont(font5)
        self.prof_5.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_5)

        self.prof_6 = QLabel(self.profession)
        ...
        self.prof_6.setPalette(palette12)
        self.prof_6.setFont(font5)
        self.prof_6.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_6)

        self.prof_7 = QLabel(self.profession)
        ...
        self.prof_7.setPalette(palette13)
        self.prof_7.setFont(font5)
        self.prof_7.setStyleSheet(u"border: none;")

        self.verticalLayout.addWidget(self.prof_7)

        self.prof_8 = QLabel(self.profession)
        ...
        self.prof_8.setPalette(palette14)
        self.prof_8.setFont(font5)
        ...
        self.pushButtonMore.setPalette(palette15)
        font6 = QFont()
...
"}")
        ...
        self.professionAdd = QFrame(self.professionPage)
...
"}")
        ...
        self.textAdd.setPalette(palette16)
        ...
        self.textAdd_2.setPalette(palette17)
        self.textAdd_2.setFont(font2)
        self.textAdd_2.setStyleSheet(u"border: none;")

        self.gridProfessions.addWidget(self.professionAdd, 1, 1, 1, 1)

        self.profession_10 = QFrame(self.professionPage)
        self.profession_10.setObjectName(u"profession_10")
        self.profession_10.setMaximumSize(QSize(346, 16777215))
        self.profession_10.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_19 = QVBoxLayout(self.profession_10)
        self.verticalLayout_19.setSpacing(15)
        self.verticalLayout_19.setObjectName(u"verticalLayout_19")
        self.verticalLayout_19.setContentsMargins(20, 20, 20, 20)
        self.professionButtons_5 = QHBoxLayout()
        self.professionButtons_5.setObjectName(u"professionButtons_5")
        self.professionName_5 = QLabel(self.profession_10)
        self.professionName_5.setObjectName(u"professionName_5")
        self.professionName_5.setMinimumSize(QSize(248, 0))
        palette18 = QPalette()
        ...
        self.professionName_5.setPalette(palette18)
        self.professionName_5.setFont(font4)
        self.professionName_5.setStyleSheet(u"border: none;")

        self.professionButtons_5.addWidget(self.professionName_5)

        self.buttons_5 = QHBoxLayout()
        self.buttons_5.setSpacing(10)
        self.buttons_5.setObjectName(u"buttons_5")
        self.pushButtonRedact_5 = QPushButton(self.profession_10)
...
"}")
        ...
        self.pushButtonDelete_5 = QPushButton(self.profession_10)
...
"}")
        ...
        self.professionButtons_5.addLayout(self.buttons_5)


        self.verticalLayout_19.addLayout(self.professionButtons_5)

        self.verticalLayout_20 = QVBoxLayout()
        self.verticalLayout_20.setSpacing(10)
        self.verticalLayout_20.setObjectName(u"verticalLayout_20")
        self.vacancy_5 = QLabel(self.profession_10)
        ...
        self.prof_33.setPalette(palette20)
        self.prof_33.setFont(font5)
        self.prof_33.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_33)

        self.prof_34 = QLabel(self.profession_10)
        ...
        self.prof_34.setPalette(palette21)
        self.prof_34.setFont(font5)
        self.prof_34.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_34)

        self.prof_35 = QLabel(self.profession_10)
        ...
        self.prof_35.setPalette(palette22)
        self.prof_35.setFont(font5)
        self.prof_35.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_35)

        self.prof_36 = QLabel(self.profession_10)
        ...
        self.prof_36.setPalette(palette23)
        self.prof_36.setFont(font5)
        self.prof_36.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_36)

        self.prof_37 = QLabel(self.profession_10)
        ...
        self.prof_37.setPalette(palette24)
        self.prof_37.setFont(font5)
        self.prof_37.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_37)

        self.prof_38 = QLabel(self.profession_10)
        ...
        self.prof_38.setPalette(palette25)
        self.prof_38.setFont(font5)
        self.prof_38.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_38)

        self.prof_39 = QLabel(self.profession_10)
        ...
        self.prof_39.setPalette(palette26)
        self.prof_39.setFont(font5)
        self.prof_39.setStyleSheet(u"border: none;")

        self.verticalLayout_20.addWidget(self.prof_39)

        self.prof_40 = QLabel(self.profession_10)
        ...
        self.prof_40.setPalette(palette27)
        self.prof_40.setFont(font5)
        ...
        self.pushButtonMore_10 = QPushButton(self.profession_10)
        ...
        self.pushButtonMore_10.setPalette(palette28)
        self.pushButtonMore_10.setFont(font6)
...
"}")
        ...
        self.gridProfessions.addWidget(self.profession_10, 0, 3, 1, 1)

        self.profession_7 = QFrame(self.professionPage)
        self.profession_7.setObjectName(u"profession_7")
        self.profession_7.setMaximumSize(QSize(346, 16777215))
        self.profession_7.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_13 = QVBoxLayout(self.profession_7)
        self.verticalLayout_13.setSpacing(15)
        self.verticalLayout_13.setObjectName(u"verticalLayout_13")
        self.verticalLayout_13.setContentsMargins(20, 20, 20, 20)
        self.professionButtons_2 = QHBoxLayout()
        self.professionButtons_2.setObjectName(u"professionButtons_2")
        self.professionName_2 = QLabel(self.profession_7)
        self.professionName_2.setObjectName(u"professionName_2")
        self.professionName_2.setMinimumSize(QSize(248, 0))
        palette29 = QPalette()
        ...
        self.professionName_2.setPalette(palette29)
        self.professionName_2.setFont(font4)
        self.professionName_2.setStyleSheet(u"border: none;")

        self.professionButtons_2.addWidget(self.professionName_2)

        self.buttons_2 = QHBoxLayout()
        self.buttons_2.setSpacing(10)
        self.buttons_2.setObjectName(u"buttons_2")
        self.pushButtonRedact_2 = QPushButton(self.profession_7)
...
"}")
        ...
        self.pushButtonDelete_2 = QPushButton(self.profession_7)
...
"}")
        ...
        self.professionButtons_2.addLayout(self.buttons_2)


        self.verticalLayout_13.addLayout(self.professionButtons_2)

        self.verticalLayout_14 = QVBoxLayout()
        self.verticalLayout_14.setSpacing(10)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.vacancy_2 = QLabel(self.profession_7)
        ...
        self.prof_9.setPalette(palette31)
        self.prof_9.setFont(font5)
        self.prof_9.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_9)

        self.prof_10 = QLabel(self.profession_7)
        ...
        self.prof_10.setPalette(palette32)
        self.prof_10.setFont(font5)
        self.prof_10.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_10)

        self.prof_11 = QLabel(self.profession_7)
        ...
        self.prof_11.setPalette(palette33)
        self.prof_11.setFont(font5)
        self.prof_11.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_11)

        self.prof_12 = QLabel(self.profession_7)
        ...
        self.prof_12.setPalette(palette34)
        self.prof_12.setFont(font5)
        self.prof_12.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_12)

        self.prof_13 = QLabel(self.profession_7)
        ...
        self.prof_13.setPalette(palette35)
        self.prof_13.setFont(font5)
        self.prof_13.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_13)

        self.prof_14 = QLabel(self.profession_7)
        ...
        self.prof_14.setPalette(palette36)
        self.prof_14.setFont(font5)
        self.prof_14.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_14)

        self.prof_15 = QLabel(self.profession_7)
        ...
        self.prof_15.setPalette(palette37)
        self.prof_15.setFont(font5)
        self.prof_15.setStyleSheet(u"border: none;")

        self.verticalLayout_14.addWidget(self.prof_15)

        self.prof_16 = QLabel(self.profession_7)
        ...
        self.prof_16.setPalette(palette38)
        self.prof_16.setFont(font5)
        ...
        self.pushButtonMore_7 = QPushButton(self.profession_7)
        ...
        self.pushButtonMore_7.setPalette(palette39)
        self.pushButtonMore_7.setFont(font6)
...
"}")
        ...
        self.gridProfessions.addWidget(self.profession_7, 0, 1, 1, 1)

        self.profession_8 = QFrame(self.professionPage)
        self.profession_8.setObjectName(u"profession_8")
        self.profession_8.setMaximumSize(QSize(346, 16777215))
        self.profession_8.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_15 = QVBoxLayout(self.profession_8)
        self.verticalLayout_15.setSpacing(15)
        self.verticalLayout_15.setObjectName(u"verticalLayout_15")
        self.verticalLayout_15.setContentsMargins(20, 20, 20, 20)
        self.professionButtons_3 = QHBoxLayout()
        self.professionButtons_3.setObjectName(u"professionButtons_3")
        self.professionName_3 = QLabel(self.profession_8)
        self.professionName_3.setObjectName(u"professionName_3")
        self.professionName_3.setMinimumSize(QSize(248, 0))
        palette40 = QPalette()
        ...
        self.professionName_3.setPalette(palette40)
        self.professionName_3.setFont(font4)
        self.professionName_3.setStyleSheet(u"border: none;")

        self.professionButtons_3.addWidget(self.professionName_3)

        self.buttons_3 = QHBoxLayout()
        self.buttons_3.setSpacing(10)
        self.buttons_3.setObjectName(u"buttons_3")
        self.pushButtonRedact_3 = QPushButton(self.profession_8)
...
"}")
        ...
        self.pushButtonDelete_3 = QPushButton(self.profession_8)
...
"}")
        ...
        self.professionButtons_3.addLayout(self.buttons_3)


        self.verticalLayout_15.addLayout(self.professionButtons_3)

        self.verticalLayout_16 = QVBoxLayout()
        self.verticalLayout_16.setSpacing(10)
        self.verticalLayout_16.setObjectName(u"verticalLayout_16")
        self.vacancy_3 = QLabel(self.profession_8)
        ...
        self.prof_17.setPalette(palette42)
        self.prof_17.setFont(font5)
        self.prof_17.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_17)

        self.prof_18 = QLabel(self.profession_8)
        ...
        self.prof_18.setPalette(palette43)
        self.prof_18.setFont(font5)
        self.prof_18.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_18)

        self.prof_19 = QLabel(self.profession_8)
        ...
        self.prof_19.setPalette(palette44)
        self.prof_19.setFont(font5)
        self.prof_19.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_19)

        self.prof_20 = QLabel(self.profession_8)
        ...
        self.prof_20.setPalette(palette45)
        self.prof_20.setFont(font5)
        self.prof_20.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_20)

        self.prof_21 = QLabel(self.profession_8)
        ...
        self.prof_21.setPalette(palette46)
        self.prof_21.setFont(font5)
        self.prof_21.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_21)

        self.prof_22 = QLabel(self.profession_8)
        ...
        self.prof_22.setPalette(palette47)
        self.prof_22.setFont(font5)
        self.prof_22.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_22)

        self.prof_23 = QLabel(self.profession_8)
        ...
        self.prof_23.setPalette(palette48)
        self.prof_23.setFont(font5)
        self.prof_23.setStyleSheet(u"border: none;")

        self.verticalLayout_16.addWidget(self.prof_23)

        self.prof_24 = QLabel(self.profession_8)
        ...
        self.prof_24.setPalette(palette49)
        self.prof_24.setFont(font5)
        ...
        self.pushButtonMore_8 = QPushButton(self.profession_8)
        ...
        palette50.setBrush(QPalette.Active, QPalette.Text, brush3)
        ...
        palette50.setBrush(QPalette.Inactive, QPalette.Text, brush3)
        ...
        self.pushButtonMore_8.setPalette(palette50)
...
"}")
        ...
        self.gridProfessions.addWidget(self.profession_8, 0, 4, 1, 1)

        self.profession_9 = QFrame(self.professionPage)
        self.profession_9.setObjectName(u"profession_9")
        self.profession_9.setMaximumSize(QSize(346, 16777215))
        self.profession_9.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_17 = QVBoxLayout(self.profession_9)
        self.verticalLayout_17.setSpacing(15)
        self.verticalLayout_17.setObjectName(u"verticalLayout_17")
        self.verticalLayout_17.setContentsMargins(20, 20, 20, 20)
        self.professionButtons_4 = QHBoxLayout()
        self.professionButtons_4.setObjectName(u"professionButtons_4")
        self.professionName_4 = QLabel(self.profession_9)
        self.professionName_4.setObjectName(u"professionName_4")
        self.professionName_4.setMinimumSize(QSize(248, 0))
        palette51 = QPalette()
        ...
        self.professionName_4.setPalette(palette51)
        self.professionName_4.setFont(font4)
        self.professionName_4.setStyleSheet(u"border: none;")

        self.professionButtons_4.addWidget(self.professionName_4)

        self.buttons_4 = QHBoxLayout()
        self.buttons_4.setSpacing(10)
        self.buttons_4.setObjectName(u"buttons_4")
        self.pushButtonRedact_4 = QPushButton(self.profession_9)
...
"}")
        ...
        self.pushButtonDelete_4 = QPushButton(self.profession_9)
...
"}")
        ...
        self.professionButtons_4.addLayout(self.buttons_4)


        self.verticalLayout_17.addLayout(self.professionButtons_4)

        self.verticalLayout_18 = QVBoxLayout()
        self.verticalLayout_18.setSpacing(10)
        self.verticalLayout_18.setObjectName(u"verticalLayout_18")
        self.vacancy_4 = QLabel(self.profession_9)
        ...
        self.prof_25.setPalette(palette53)
        self.prof_25.setFont(font5)
        self.prof_25.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_25)

        self.prof_26 = QLabel(self.profession_9)
        ...
        self.prof_26.setPalette(palette54)
        self.prof_26.setFont(font5)
        self.prof_26.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_26)

        self.prof_27 = QLabel(self.profession_9)
        ...
        self.prof_27.setPalette(palette55)
        self.prof_27.setFont(font5)
        self.prof_27.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_27)

        self.prof_28 = QLabel(self.profession_9)
        ...
        self.prof_28.setPalette(palette56)
        self.prof_28.setFont(font5)
        self.prof_28.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_28)

        self.prof_29 = QLabel(self.profession_9)
        ...
        self.prof_29.setPalette(palette57)
        self.prof_29.setFont(font5)
        self.prof_29.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_29)

        self.prof_30 = QLabel(self.profession_9)
        ...
        self.prof_30.setPalette(palette58)
        self.prof_30.setFont(font5)
        self.prof_30.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_30)

        self.prof_31 = QLabel(self.profession_9)
        ...
        self.prof_31.setPalette(palette59)
        self.prof_31.setFont(font5)
        self.prof_31.setStyleSheet(u"border: none;")

        self.verticalLayout_18.addWidget(self.prof_31)

        self.prof_32 = QLabel(self.profession_9)
        ...
        self.prof_32.setPalette(palette60)
        self.prof_32.setFont(font5)
        ...
        self.pushButtonMore_9 = QPushButton(self.profession_9)
        ...
        palette61.setBrush(QPalette.Active, QPalette.Text, brush3)
        ...
        palette61.setBrush(QPalette.Inactive, QPalette.Text, brush3)
        ...
        self.pushButtonMore_9.setPalette(palette61)
        self.pushButtonMore_9.setFont(font6)
...
"}")
        ...
        self.gridProfessions.addWidget(self.profession_9, 0, 2, 1, 1)

        self.profession_2 = QFrame(self.professionPage)
        self.profession_2.setObjectName(u"profession_2")
        self.profession_2.setMaximumSize(QSize(346, 16777215))
        self.profession_2.setStyleSheet(u"QFrame {\n"
"	border-right: 2px solid #E7E7E7;\n"
"	border-bottom: 2px solid #E7E7E7;\n"
"	border-radius: 10px;\n"
"}")
        self.verticalLayout_3 = QVBoxLayout(self.profession_2)
        self.verticalLayout_3.setSpacing(15)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.verticalLayout_3.setContentsMargins(20, 20, 20, 20)
        self.professionButtons_6 = QHBoxLayout()
        self.professionButtons_6.setObjectName(u"professionButtons_6")
        self.professionName_6 = QLabel(self.profession_2)
        self.professionName_6.setObjectName(u"professionName_6")
        self.professionName_6.setMinimumSize(QSize(248, 0))
        palette62 = QPalette()
        ...
        self.professionName_6.setPalette(palette62)
        self.professionName_6.setFont(font4)
        self.professionName_6.setStyleSheet(u"border: none;")

        self.professionButtons_6.addWidget(self.professionName_6)

        self.buttons_6 = QHBoxLayout()
        self.buttons_6.setSpacing(10)
        self.buttons_6.setObjectName(u"buttons_6")
        self.pushButtonRedact_6 = QPushButton(self.profession_2)
...
"}")
        ...
        self.pushButtonDelete_6 = QPushButton(self.profession_2)
...
"}")
        ...
        self.professionButtons_6.addLayout(self.buttons_6)


        self.verticalLayout_3.addLayout(self.professionButtons_6)

        self.verticalLayout_4 = QVBoxLayout()
        self.verticalLayout_4.setSpacing(10)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.vacancy_6 = QLabel(self.profession_2)
        ...
        self.prof_41.setPalette(palette64)
        self.prof_41.setFont(font5)
        self.prof_41.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_41)

        self.prof_42 = QLabel(self.profession_2)
        self.prof_42.setObjectName(u"prof_42")
        palette65 = QPalette()
        palette65.setBrush(QPalette.Active, QPalette.WindowText, brush3)
        ...
        palette65.setBrush(QPalette.Inactive, QPalette.WindowText, brush3)
        ...
        self.prof_42.setPalette(palette65)
        self.prof_42.setFont(font5)
        self.prof_42.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_42)

        self.prof_43 = QLabel(self.profession_2)
        ...
        self.prof_43.setPalette(palette66)
        self.prof_43.setFont(font5)
        self.prof_43.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_43)

        self.prof_44 = QLabel(self.profession_2)
        ...
        self.prof_44.setPalette(palette67)
        self.prof_44.setFont(font5)
        self.prof_44.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_44)

        self.prof_45 = QLabel(self.profession_2)
        ...
        self.prof_45.setPalette(palette68)
        self.prof_45.setFont(font5)
        self.prof_45.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_45)

        self.prof_46 = QLabel(self.profession_2)
        ...
        self.prof_46.setPalette(palette69)
        self.prof_46.setFont(font5)
        self.prof_46.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_46)

        self.prof_47 = QLabel(self.profession_2)
        ...
        self.prof_47.setPalette(palette70)
        self.prof_47.setFont(font5)
        self.prof_47.setStyleSheet(u"border: none;")

        self.verticalLayout_4.addWidget(self.prof_47)

        self.prof_48 = QLabel(self.profession_2)
        self.prof_48.setObjectName(u"prof_48")
        palette71 = QPalette()
        palette71.setBrush(QPalette.Active, QPalette.WindowText, brush3)
        ...
        palette71.setBrush(QPalette.Inactive, QPalette.WindowText, brush3)
        ...
        self.prof_48.setPalette(palette71)
        self.prof_48.setFont(font5)
        ...
        self.pushButtonMore_2 = QPushButton(self.profession_2)
        ...
        palette72.setBrush(QPalette.Active, QPalette.Text, brush3)
        ...
        palette72.setBrush(QPalette.Inactive, QPalette.Text, brush3)
...
"}")
        ...
        self.gridProfessions.addWidget(self.profession_2, 1, 0, 1, 1)


        self.professions.addLayout(self.gridProfessions)

        self.verticalScrollBar = QScrollBar(self.professionPage)
        ...
        self.verticalScrollBar.setPalette(palette73)
...
"}")
        ...
        self.verticalLayout_5.addLayout(self.professions)
    ...
    def retranslateUi(self, ProfessionPage):
...
#endif // QT_CONFIG(shortcut)
        self.vacancy.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_1.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_2.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_3.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_4.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_5.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_6.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_7.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_8.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        ...
        self.professionName_5.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446", None))
...
#endif // QT_CONFIG(shortcut)
        self.vacancy_5.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_33.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_34.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_35.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_36.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_37.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_38.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_39.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_40.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        self.pushButtonMore_10.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0435\u0449\u0451", None))
        self.professionName_2.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446", None))
...
#endif // QT_CONFIG(shortcut)
        self.vacancy_2.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_9.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_10.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_11.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_12.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_13.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_14.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_15.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_16.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        self.pushButtonMore_7.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0435\u0449\u0451", None))
        self.professionName_3.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446", None))
...
#endif // QT_CONFIG(shortcut)
        self.vacancy_3.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_17.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_18.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_19.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_20.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_21.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_22.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_23.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_24.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        self.pushButtonMore_8.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0435\u0449\u0451", None))
        self.professionName_4.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446", None))
...
#endif // QT_CONFIG(shortcut)
        self.vacancy_4.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_25.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_26.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_27.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_28.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_29.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_30.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_31.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_32.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        self.pushButtonMore_9.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0435\u0449\u0451", None))
        self.professionName_6.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446", None))
...
#endif // QT_CONFIG(shortcut)
        self.vacancy_6.setText(QCoreApplication.translate("ProfessionPage", u"\u0412\u0430\u043a\u0430\u043d\u0441\u0438\u0438", None))
        self.prof_41.setText(QCoreApplication.translate("ProfessionPage", u"\u041c\u0435\u043d\u0435\u0434\u0436\u0435\u0440 \u043f\u043e \u043f\u0440\u043e\u0434\u0430\u0436\u0430\u043c", None))
        self.prof_42.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440", None))
        self.prof_43.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0435", None))
        self.prof_44.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u0430\u0432\u0442\u043e\u0441\u0430\u043b\u043e\u043d\u0430", None))
        self.prof_45.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u0440\u043e\u0434\u0430\u0432\u0435\u0446 \u0432 \u0441\u0444\u0435\u0440\u0435 \u043f\u0440\u043e\u0434\u0430\u0436", None))
        self.prof_46.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_47.setText(QCoreApplication.translate("ProfessionPage", u"\u0421\u0442\u0430\u0440\u0448\u0438\u0439 \u043a\u0430\u0441\u0441\u0438\u0440", None))
        self.prof_48.setText(QCoreApplication.translate("ProfessionPage", u"\u041a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u043d\u0442 \u041c\u0430\u0433\u043d\u0438\u0442", None))
        self.pushButtonMore_2.setText(QCoreApplication.translate("ProfessionPage", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0435\u0449\u0451", None))
    # retranslateUi
